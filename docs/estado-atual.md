...
- **Implementado:** schema/migration, autenticação/RBAC, sessões revogáveis, catálogo/inativação, pedido móvel persistente/versionado, conferência A4, Docker, stack Swarm e workflows CI/release. O GitHub Actions publicou a imagem e promoveu `sha-4be40e8276a78801a76b7c8f913f9d832d1dbc07` no manifesto; o webhook não foi chamado por secret ausente.
