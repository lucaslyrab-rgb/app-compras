...
- **Implementado:** schema/migration, autenticação/RBAC, sessões revogáveis, catálogo/inativação, pedido móvel persistente/versionado, conferência A4, Docker, stack Swarm e workflows CI/release. O GitHub Actions publicou a imagem e promoveu `sha-ce0e7f0ddca6a3690fbec8f030c7dec0e963c92f` no manifesto; o deploy manual validado está saudável, e o webhook GitOps ainda aguarda cadastro.
